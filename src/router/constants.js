...
export const RECEPTION_TODAYSPATIIENT = `${ROOT_ROUTE}/todayspatient`;
export const RECEPTION_VISITS = `${ROOT_ROUTE}/visits`;
export const RECEPTION_PROCEDURES = `${ROOT_ROUTE}/procedures`;
export const FORGOT_PASSWORD = `${ROOT_ROUTE}/forgot_password`;
export const SEARCH_DOCTORS = `${ROOT_ROUTE}/search_doctors`;
export const PAYMENTS = `${ROOT_ROUTE}/payments`;
export const SETTINGS = `${ROOT_ROUTE}/settings`;